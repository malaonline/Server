 ...
 */
public class CircleProgressbar extends AnimatedView {
    ...
    private void initColorAttributes(TypedArray a) {
        mIndeterminateColor = a.getColor(R.styleable.CircleProgressbar_indeterminate_color, DEFAULT_INDETERMINATE_COLOR);
        mProgressPendingColor = a.getColor(R.styleable.CircleProgressbar_progress_pending_color, DEFAULT_PROGRESS_PENDING_COLOR);
        mProgressFirstPhaseColor = a.getColor(R.styleable.CircleProgressbar_progress_first_phase_color, DEFAULT_PROGRESS_FIRST_PHASE_COLOR);
        mProgressSecondPhaseColor = a.getColor(R.styleable.CircleProgressbar_progress_second_phase_color, DEFAULT_PROGRESS_SECOND_PHASE_COLOR);
    }

    private void initValueAttributes(TypedArray a) {
        mProgress = a.getFloat(R.styleable.CircleProgressbar_progress, DEFAULT_PROGRESS_VALUE);
    }
