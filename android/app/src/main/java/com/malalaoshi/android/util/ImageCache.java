...
public class ImageCache implements ImageLoader.ImageCache {
    ...
    private static final int DEFAULT_MEM_CACHE_SIZE = 1024 * 25; // 25MB
    ...
    public static ImageCache getInstance(Context context) {
        if (mImageCache == null) {
            mImageCache = new ImageCache(new ImageCacheParams(context));
        }
        return mImageCache;
    }
    ...
    public static ImageCache getInstance(ImageCacheParams cacheParams) {
        // No existing ImageCache, create one
        if (mImageCache == null) {
            ...
            mMemoryCache = new LruCache<String, Bitmap>(mCacheParams.memCacheSize) {
                ...
                protected void entryRemoved(boolean evicted, String key,
                    ...
                    if (evicted) {
                        ...
                        if (BuildConfig.DEBUG) {
                            Log.d(TAG, "One bitmap is put away to reuse");
                        }
                    } else {
                        oldValue.recycle();
                        if (BuildConfig.DEBUG) {
                            Log.d(TAG, "One bitmap is recycled");
                        }
                    }
                }
...
//        }
    ...
    public static class ImageCacheParams {
        ...
        public ImageCacheParams(Context context) {
            this(context, DEFAULT_IMAGE_CACHE_DIR);
        }
