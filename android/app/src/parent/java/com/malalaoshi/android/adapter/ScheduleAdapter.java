    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder){
            ...
            if (avatarUrl != null && !avatarUrl.equals("")) {
                ((ItemViewHolder)holder).ivTeacherAvatar.setDefaultImageResId(R.drawable.user_detail_header_bg);
                ((ItemViewHolder)holder).ivTeacherAvatar.setErrorImageResId(R.drawable.user_detail_header_bg);
