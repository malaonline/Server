...
urlpatterns = [
    ...
    url(r'^school/account/info_v2/$', views.SchoolAccountInfoViewV2.as_view(), name="school_account_info_v2"),
    ...
    url(r'^school/account/income/records_v2/$', views.SchoolIncomeRecordViewV2.as_view(), name="school_income_records_v2"),
    url(r'^school/account/income/audit_v2/$', views.SchoolIncomeAuditViewV2.as_view(), name="school_income_audit_v2"),
