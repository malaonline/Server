    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('superset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, default=None, to='app.Grade')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=1, default='p', choices=[('p', '待认证'), ('a', '已认证'), ('r', '已拒绝')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leaf', models.BooleanField()),
                ('superset', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, default=None, to='app.Region')),
            ],
            options={
                'abstract': False,
            },
