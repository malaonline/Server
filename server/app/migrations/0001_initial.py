    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.ImageField(null=True, blank=True, upload_to='schools')),
        ...
        migrations.AddField(
            model_name='accounthistory',
            name='done_by',
            field=models.ForeignKey(blank=True, null=True, to=settings.AUTH_USER_MODEL, related_name='processed_withdraws'),
        ),
        migrations.AddField(
            model_name='account',
            name='teacher',
