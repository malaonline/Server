...
#xctool -workspace mala-ios.xcworkspace -scheme ${scheme} -configuration DevDebug -sdk iphonesimulator -destination 'platform=iOS Simulator,name=iPhone 5s,OS=8.3' test -freshSimulator
